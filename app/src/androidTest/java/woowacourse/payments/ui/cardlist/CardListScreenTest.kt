...
import woowacourse.payments.CARD_FIXTURE_1
...
class CardListScreenTest {
    ...
    fun 카드가_하나도_없을_때는_카드_추가_안내_문구가_표시된다() {
        ...
        // when
        composeTestRule.setContent { CardListScreen(cards, {}, { _ -> }) }
    ...
    fun 카드가_한_개_이상일_때는_카드_추가_안내_문구가_표시되지_않는다() {
        // given
        val cards = mutableStateListOf(CARD_FIXTURE_0)
    ...
    fun 카드가_두_개_이상일_때는_카드_추가_버튼이_문구로_표시된다() {
        // given
        val cards = mutableStateListOf(CARD_FIXTURE_0, CARD_FIXTURE_1)

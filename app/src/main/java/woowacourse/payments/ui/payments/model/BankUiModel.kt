...
enum class BankUiModel(
    ...
    KAKAO(R.string.bank_ui_model_kakao_bank_name, R.color.kakao_color, R.drawable.ic_kakao_bank),
    HYUNDAI(
    ...
    LOTTE(R.string.bank_ui_model_lotte_bank_name, R.color.lotte_color, R.drawable.ic_lotte_bank),
    HANA(R.string.bank_ui_model_hana_bank_name, R.color.hana_color, R.drawable.ic_hana_bank),
    KB(R.string.bank_ui_model_kb_bank_name, R.color.kb_color, R.drawable.ic_kb_bank),
}

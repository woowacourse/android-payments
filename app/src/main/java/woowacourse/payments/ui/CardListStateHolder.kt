...
class CardListStateHolder {
    ...
    suspend fun onAddCardResult(activityResult: ActivityResult) {
        val newCard = AddCardActivity.parsePaymentCardUiModelByAddCard(activityResult) ?: return
    ...
    suspend fun onEditCardResult(activityResult: ActivityResult) {
        val editedCard = EditcardActivity.parsePaymentCardUiModelByEditCard(activityResult) ?: return

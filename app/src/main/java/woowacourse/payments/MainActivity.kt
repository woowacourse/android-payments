                ...
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding: PaddingValues ->
                    Column(modifier = Modifier.fillMaxSize()) {
                        ...
                        Column(
                            ...
                            OutlinedTextField("MM / YY", "만료일", Modifier.fillMaxWidth(0.5F))
                            OutlinedTextField("카드에 표시된 이름을 입력하세요.", "카드 소유자 이름(선택)", Modifier.fillMaxWidth())
                            OutlinedTextField("0000", "비밀번호", Modifier.fillMaxWidth(0.5F))
                        }
                    }
                }
            }
